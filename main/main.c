...
void app_main(void)
{
    ...
    xTaskCreate(tcp_server_task, "server", 8192, NULL, 2, NULL);
    xTaskCreate(dmx_Read, "READ", 8192, NULL, 7, NULL);
    xTaskCreate(tUSB_DMXI_parser, "tUSB_DMXI_parser", 8192, NULL, 5, NULL);
    xTaskCreate(tUSB_DMXI_sender, "tUSB_DMXI_sender", 8192, NULL, 6, NULL);
